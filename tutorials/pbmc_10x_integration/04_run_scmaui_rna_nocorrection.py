...
#test adv last layer
outputpath = './scmaui_pbmc_rna_nocorr_v1'

datapaths = ['data/gtxcombined.h5ad']

adatas = load_data(datapaths, ['gtx'])
dataset = SCMauiDataset(adatas, losses=['negbinom'], union=True)
print(dataset)
...
params['nhidden_e'] = 128
params['nlatent'] = 30
#params['losses'] = ['negbinom']
print(params)

ensemblevae = EnsembleVAE(params=params)

ensemblevae.fit(dataset, epochs=300, batch_size=64)
